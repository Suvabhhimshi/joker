...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Jok");
    case mBTC: return QString("mJok");
    case uBTC: return QString::fromUtf8("μJok");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("JokerCoins"));
    case mBTC: return QString(QObject::tr("Milli-JokerCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-JokerCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
